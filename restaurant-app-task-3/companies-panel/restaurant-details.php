...
?>
    ...
    <body>
        ...
        <?php $restaurant = Restaurants::getRestaurantWithId($_GET['id']);
        ?>
        <center>
            <h1>Restoran Ayrıntıları</h1>
            ...
            <div class="login-form">
                <form action="/src/restaurants.php" method="POST" enctype="multipart/form-data">
                    <div class="form-group">
                        ...
                        <input type="text" name="name" class="form-control" id="name" value=<?php echo $restaurant['name']; ?> required>
                    </div>
                    <div class="form-group">
                        <label for="description">Açıklama</label>
                        <input type="text" name="description" class="form-control" id="description" value=<?php echo $restaurant['description']; ?> required>
                    </div>
                    <div class="form-group">
                        <label for="image_path">Resim Yükle</label>
                        <img src="<?php echo $restaurant['image_path']; ?>">
                        <input type="file" name="image_path" class="form-control" id="image_path" placeholder="Resim Yükle" accept="image/*">
                    </div>
                    <div class="form-group">
                        ...
                        <select name="company_id" class="form-control" id="company_id" required>
                            ...
                            foreach ($companies as $company): ?>
                                <option value="<?php echo $company['id']; ?>"
                                    <?php echo ($company['id'] == $restaurant['company_id']) ? 'selected' : ''; ?>>
